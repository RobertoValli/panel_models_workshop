...
\title{
	 Recent Developments in Methods for Causal Inference with Cross-Sectional Time-Series Data\thanks{Find the worshop's GitHub repo at \url{https://github.com/RobertoValli/panel_models_workshop}.}\\[1em]
